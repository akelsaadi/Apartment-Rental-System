...
namespace TEAM4OARS.Models
{
    ...
    public partial class TEAM4OARSEntities : DbContext
    {
        ...
        public virtual DbSet<View_Pending_Complaints> View_Pending_Complaints { get; set; }
        ...
        public virtual DbSet<View_List_Payments> View_List_Payments { get; set; }
        public virtual DbSet<View_StaffRental_Details> View_StaffRental_Details { get; set; }
    
        public virtual ObjectResult<sp_findTestimonial_Result> sp_findTestimonial(string keyword)
        {
            var keywordParameter = keyword != null ?
                new ObjectParameter("Keyword", keyword) :
                new ObjectParameter("Keyword", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_findTestimonial_Result>("sp_findTestimonial", keywordParameter);
        }
    }
}
